...
At the moment, I am contributing to the Chromium Web browser. I am also collaborating with the University of Kyoto's CSEAS as an affiliated researcher.
...
Final year project: "Compilation of BPEL conditions & assign activities into Java code" at the University of Stuttgart, Germany.
...
* Contributions to eos-sdk
* Contributions to eos-social
* Contributions to eos-theme
* Contributions to eos-app-store
* Contributions to eos-shell-content
* Contributions to libmeegotouch
* Contributions to libmeegotouch-theme
* Contributions to hildon-input-method
* Contributions to hildon-input-method-framework
* Contributions to hildon-application-manager
* Contributions to modest
...
* Working on the implementation of the CSS properties scrollbar-width and scrollbar-color defined in the CSS Scrollbars spec: Bug 891944
* Implemented the scrollbar-gutter CSS property, which gives Web authors more control over how their layouts respond to the presence/absence of scrollbars. More details in the CSS Layout spec, in the explainer document, and in the MDN entry.
  - Code contributions are linked in Bug 710214.
  - Identified and fixed a related bug in the DevTools highlight: discussion in the DevTools group
  - Participated in CSS Working Group discussions regarding inheritability, drawing over, block direction, overflowing and viewport units.
* Ongoing work and interest on enabling richer colors in the browser: Bug 1026287
* Implemented the "auto" value for the -webkit-appearance CSS property: Bug 965432
...
You can check this work at the university website or download one of the links below.
...
For over a year, I worked with Endless in adapting the GNOME desktop to make it suitable for embedded computers targeted at the developing world. This project had a strong focus on design and UX, not just to make it attractive, but to ensure that the solution was suited for the intended audience and context.
...
For my MSc. Project in York, I designed an interface to better match document retrieval with the way human memory works. I focused on the file-opening dialog as a point of contact between the personal archive and the current activity.
...
I was the main developer of the Hildon Input Method project on the year running up to the release of the N900 (2009). This was a set of libraries and utilities that managed text input on the Maemo platform. Among other features, I implemented word completion using the HW keyboard, an on-screen view to input special characters, a configuration applet, and several improvements to the on-screen keyboard. I worked closely with designers and testers, suggesting and prototyping improvements.
...
I also worked on the Modest email client, the default music player, and others (2007).
